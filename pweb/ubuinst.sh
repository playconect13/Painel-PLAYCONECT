...
#echo -e "\n\033[1;36mVERIFICANDO... \033[1;37m $_key_\033[0m" ; rm $_Ink/list > /dev/null 2>&1; wget -P $_Ink https://github.com/playconect13/Painel-PLAYCONECT/raw/main/pweb/chave > /dev/null 2>&1; verif_key
#sleep 3s
#echo -e "\n\033[1;32mKEY VALIDA!\033[1;32m"
#sleep 3s
#!COLOQUE SEU CÃ“DIGO DAQUI PARA BAIXO\/
#chave=$(curl -sSL "https://github.com/playconect13/Painel-PLAYCONECT/raw/main/pweb/chave") &>/dev/null
...
echo -e 'by: @asempreendimentos013' >/usr/lib/telegram
  msg -bar
...
wget https://github.com/playconect13/Painel-PLAYCONECT/raw/main/pweb/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://github.com/playconect13/Painel-PLAYCONECT/raw/main/pweb/verifatt.sh > /dev/null 2>&1
wget https://github.com/playconect13/Painel-PLAYCONECT/raw/main/pweb/verpweb > /dev/null 2>&1
wget https://github.com/playconect13/Painel-PLAYCONECT/raw/main/pweb/verweb > /dev/null 2>&1
wgethttps://github.com/playconect13/Painel-PLAYCONECT/raw/main/pweb/whatsapp.sh> /dev/null 2>&1
...
wget https://github.com/playconect13/Painel-PLAYCONECT/raw/main/pweb/gestorssh.zip > /dev/null 2>&1
...
echo ""
echo -e "PLAY CONECT" | figlet | boxes -d stone -p a0v0 | lolcat
echo -e "                              \033[1;31mBy @asempreendimentos013\033[1;36m"
echo ""
chave=$(curl -sSL "https://github.com/playconect13/Painel-PLAYCONECT/raw/main/pweb/chave") &>/dev/null
...
echo -e "PAINELWEB PLAY CONECT" | figlet | boxes -d stone -p a0v0 | lolcat
echo -e "                              \033[1;31mBy @asempreendimentos013\033[1;36m"
echo ""
...
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@asempreendimentos013\033[0m"
echo ""
