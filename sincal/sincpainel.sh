...
wget https://github.com/playconect13/Painel-PLAYCONECT/raw/main/sincal/sshplus.zip.001 > /dev/null 2>&1
wget https://github.com/playconect13/Painel-PLAYCONECT/raw/main/sincal/sshplus.zip.002 > /dev/null 2>&1
wget https://github.com/playconect13/Painel-PLAYCONECT/raw/main/sincal/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget https://github.com/playconect13/Painel-PLAYCONECT/raw/main/sincal/sincpainel.zip > /dev/null 2>&1
